...
def jaccard_similarity_coefficient(sentence_1, sentence_2):
    ...
    #sent_one = "Cord is strong, thick string."
    #sent_two = "A smile is the expression that you have on your face when you are pleased or amused, or when you are being friendly."
    #print("Calculating...\n")
    #prob_sim_sent = similarity(sent_one, sent_two)
    #print("Distance: ")
    #print(prob_sim_sent)